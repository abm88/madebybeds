...
<nav class="[ navbar navbar-fixed-top ][ navbar-bootsnipp animate ]" role="navigation">
    	<div class="[ container ]">
			...
			<div class="[ navbar-header ]">
				...
				<div class="[ animbrand ]">
					<a class="[ navbar-brand ][ animate ]" href="#">MadeByBeds test io testing</a>
				</div>
			</div>
				...
				<ul class="[ nav navbar-nav navbar-right ]">
					...
					<li>
						...
						<ul class="[ dropdown-menu ]" role="menu">
							...
							<li><a href="#" class="[ animate ]">Browse Projects <span class="[ pull-right glyphicon glyphicon-shopping-cart ]"></span></a></li>
							<li class="[ dropdown-header ]">Builders</li>
							<li><a href="#" class="[ animate ]">Course Tutors <span class="[ pull-right glyphicon glyphicon-tasks ]"></span></a></li>
