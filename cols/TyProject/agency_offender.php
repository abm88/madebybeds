    ...
    <div class="thumbnail">
      ...
      <div class="caption">
        ...
        <p><?php echo 'Gender '.$gender ?></p>
          <table>
              <tr>
                  <td><form method="get" action="profile_limited"> <a href="profile_limited.php" class="btn btn-primary" role="button">History</a></td></tr><tr><td>
            <form method="get" action="profile_limited"> <a href="profile_limited.php" class="btn btn-primary" role="button">Feed back</a> </td>
              </tr>
          </form>
          </table>
      </div>
