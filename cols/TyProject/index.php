    ...
    <div class="row">
        ...
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            ...
            <div class="account-wall">
                ...
                <input type="text" class="form-control" id="user_login" name="user_login" placeholder="User Login" required autofocus>
            ...
            <a href="agency_request.php" class="text-center new-account">Get affliation</a>
        </div>
