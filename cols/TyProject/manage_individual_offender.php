...
$query1 = mysql_query("select * from offender where offender_id = $release");
    ...
    <tr>
      ...
      <td><?php echo $row1['offender_address'];?> </td>
        ...
        <form method="get" action="manage_individual_offender.php">
            <tr><td><?php echo "<b><a href=\"manage_individual_offender.php?release={$row1['offender_id']}\"><input type=\"button\" value=\"Release\"/ class=\"btn btn-success btn-lg submit\" id=\"release\" name=\"releasing\" /> </a>"; ?>
              <?php echo "<b><a href=\"individual_history_admin.php?del={$row1['offender_id']}\"><input type=\"button\" value=\"History\"/ class=\"btn btn-info btn-lg\" id=\"del\" /></td> </a> "; ?> </td><td> </td><td> </td>
        </form>
        </tr>
        </tbody>
         </table>
