...
?>
      ...
      <th scope="row"><form method="get" action="feedback.php"><?php echo "<a href=\"profile.php?del={$row1['offender_id']}\">";?>
      ...
      <td><?php echo $row1['offender_address'];?> </td>
        <td><form metho="get" action="feedback.php"> </td>
            <td><?php echo "<a href=\"individual_history_admin.php?del={$row1['offender_id']}\"> View History</a>";?></td>
