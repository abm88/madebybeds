...
<div class="container"> 
       ...
       <center><img src="agency-bg.png" class="img-rounded" alt="Cinque Terre" width="100" height="100">
           <h2>Offenders Catogories</h2>   </center>   
...
<div class="row">
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
		<form role="form">
			...
			<hr class="colorgraph">
			<div class="row">
				<div class="col-xs-12 col-md-6"><input type="button" method="post" action="" value="Register" class="btn btn-primary btn-block btn-lg" tabindex="7" data-toggle="modal" data-target="#t_and_c_m"></div>
