...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 29, 2016 at 01:24 AM
...
--
ALTER TABLE `agency_request`
  MODIFY `agency_request_id` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `offender`
  MODIFY `offender_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
--
