    ...
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
		<form role="form" method="post" action="offender_registeration.php">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-6 col-md-6">
					<div class="form-group">
						<input type="text" name="offender_agency" id="offender_agency" class="form-control input-lg" placeholder="Status" tabindex="5">
					</div>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-6">
					<div class="form-group">
			...
			<div class="row">
				...
				<div class="col-xs-12 col-md-6"><a href="admin.php" class="btn btn-danger btn-block btn-lg">Dismiss</a></div>
			</div>
		</form>
	</div>
</div>
