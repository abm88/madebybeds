<?php
 ...
 {  
     ...
     // $upload_image = mysqli_real_escape_string($connect, $data->upload_image);
      ...
      $query = "INSERT INTO projects(project_subject, project_type, project_name, project_description) VALUES ('$project_subject', '$project_type','$project_name','$project_description')";  
